...
import {setUserData} from "../../src/redux/action/user";
import calendarIcon from "../../src/img/calendar-icon.svg";
import eyeHiddenIcon from "../../src/img/eye-icon.svg";
import eyeIcon from "../../src/img/eye-open-icon.svg";
        ...
        <main className="register">
            ...
            <div className="register__form">
                ...
                <label className="register__blockInput">
                    ...
                    <span className="calendarIcon"><Image src={calendarIcon}/></span>
                </label>
                <label className="register__blockInput">
                ...
                <label className="register__blockInput">
                    ...
                    />
                    <span className="isPSWHidden"><Image src={isHiddenPsw ? eyeHiddenIcon : eyeIcon}
                            onClick={() => setIsHiddenPsw(!isHiddenPsw)}/></span>
                </label>
                <label className="register__blockInput">
                    ...
                    />
                    <span className="isPSWHidden"><Image src={isHiddenRePsw ? eyeHiddenIcon : eyeIcon}
                              onClick={() => setIsHiddenRePsw(!isHiddenRePsw)}/></span>
